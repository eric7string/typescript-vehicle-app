...
class Cli {
  ...
  selectedVehicle: Truck | Motorbike | Car | undefined;
  exit: boolean = false;
  ...
  setVehicle(): void {
    this.selectedVehicle = this.vehicles.find(x => x.vin === this.selectedVehicleVin);
  }
    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.vehicleToTow.vin === this.selectedVehicleVin) {
          ...
          (this.selectedVehicle as Truck).tow(answers.vehicleToTow);
